...
private extension UIBezierPath {
    ...
    convenience init?(catmullRomPoints: [CGPoint], alpha: CGFloat) {
        ...
        for i in startIndex ..< endIndex { // swiftlint:disable:this identifier_name
            ...
            let p0 = catmullRomPoints[prevIndex] // swiftlint:disable:this identifier_name
            let p1 = catmullRomPoints[i] // swiftlint:disable:this identifier_name
            let p2 = catmullRomPoints[nextIndex] // swiftlint:disable:this identifier_name
            let p3 = catmullRomPoints[nextNextIndex] // swiftlint:disable:this identifier_name

            let d1 = p1.substract(p0).length() // swiftlint:disable:this identifier_name
            let d2 = p2.substract(p1).length() // swiftlint:disable:this identifier_name
            let d3 = p3.substract(p2).length() // swiftlint:disable:this identifier_name

            var b1 = p2.multiplyBy(pow(d1, 2 * alpha)) // swiftlint:disable:this identifier_name
            ...
            var b2 = p1.multiplyBy(pow(d3, 2 * alpha)) // swiftlint:disable:this identifier_name
