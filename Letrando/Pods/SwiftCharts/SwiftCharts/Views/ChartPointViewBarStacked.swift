...
open class ChartPointViewBarStacked: ChartPointViewBar {
    ...
    public required init(p1: CGPoint, p2: CGPoint, width: CGFloat, bgColor: UIColor?, stackFrames: [ChartPointViewBarStackedFrame], settings: ChartBarViewSettings, stackFrameSelectionViewUpdater: ChartViewSelector? = nil) { // swiftlint:disable:this identifier_name
        ...
        for (index, stackFrame) in stackFrames.enumerated() {
            ...
            let v = ChartBarStackFrameView(frame: firstFrame) // swiftlint:disable:this identifier_name
    ...
    override func onTap(_ sender: UITapGestureRecognizer) {
        ...
        let f = tappedStackFrame.view.frame.offsetBy(dx: frame.origin.x, dy: frame.origin.y) // swiftlint:disable:this identifier_name
    ...
    public required init(p1: CGPoint, p2: CGPoint, width: CGFloat, bgColor: UIColor?, settings: ChartBarViewSettings) { // swiftlint:disable:this identifier_name
        super.init(p1: p1, p2: p2, width: width, bgColor: bgColor, settings: settings)
    }
