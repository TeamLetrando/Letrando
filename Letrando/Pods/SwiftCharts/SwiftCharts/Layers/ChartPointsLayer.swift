...
open class ChartPointsLayer<T: ChartPoint>: ChartCoordsSpaceLayer {
    ...
    open func chartPointsForScreenLocX(_ x: CGFloat) -> [T] { // swiftlint:disable:this identifier_name
        return filterChartPoints { $0.x =~ x }
    }

    open func chartPointsForScreenLocY(_ y: CGFloat) -> [T] { // swiftlint:disable:this identifier_name
    ...
    func updateChartPointsScreenLocations(_ chartPointsModels: [ChartPointLayerModel<T>]) -> [ChartPointLayerModel<T>] {
        ...
        for i in 0..<chartPointsModelsVar.count { // swiftlint:disable:this identifier_name
