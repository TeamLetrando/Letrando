...
open class ChartPointsLineLayer<T: ChartPoint>: ChartPointsLayer<T> {
    ...
    fileprivate func updateScreenLines() {
        ...
        for i in 0..<screenLines.count { // swiftlint:disable:this identifier_name
            for j in 0..<screenLines[i].screenLine.points.count { // swiftlint:disable:this identifier_name
