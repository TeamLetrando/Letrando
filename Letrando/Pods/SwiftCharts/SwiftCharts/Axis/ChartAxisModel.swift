...
public func == (a: ChartAxisPadding, b: ChartAxisPadding) -> Bool { // swiftlint:disable:this identifier_name
    switch (a, b) {
    case (.label, .label): return true
    case (.fixed(let a), .fixed(let b)) where a == b: return true // swiftlint:disable:this identifier_name
    case (.maxLabelFixed(let a), .maxLabelFixed(let b)) where a == b: return true // swiftlint:disable:this identifier_name
    case (.labelPlus(let a), .labelPlus(let b)) where a == b: return true // swiftlint:disable:this identifier_name
