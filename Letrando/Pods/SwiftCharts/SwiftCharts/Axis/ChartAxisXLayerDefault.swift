...
class ChartAxisXLayerDefault: ChartAxisLayerDefault {
    ...
    override func generateLineDrawer(offset: CGFloat) -> ChartLineDrawer {
        let y = axisLineY(offset: offset) // swiftlint:disable:this identifier_name
        ...
        let p2 = CGPoint(x: axis.lastVisibleScreen + settings.axisStrokeWidth, y: y) // swiftlint:disable:this identifier_name
    ...
    fileprivate func generateAxisTitleLabelsDrawers(_ labels: [ChartAxisLabel], spacingLabelAxisX: CGFloat, spacingLabelBetweenAxis: CGFloat, offset: CGFloat) -> [ChartLabelDrawer] {
        ...
        return labels.enumerated().map { index, label in
            ...
            let x = (axis.lastScreenInit - axis.firstScreenInit) / 2 + axis.firstScreenInit - labelWidth / 2 // swiftlint:disable:this identifier_name
            let y = self.offset + offset + rowY // swiftlint:disable:this identifier_name
    ...
    override func generateDirectLabelDrawers(offset: CGFloat) -> [ChartAxisValueLabelDrawers] {
        ...
        return scalars.compactMap {scalar in
            ...
            let labelDrawers: [ChartLabelDrawer] = labels.enumerated().map { index, label in
                ...
                let x = axis.screenLocForScalar(scalar) // swiftlint:disable:this identifier_name
                let y = self.offset + offset + rowY // swiftlint:disable:this identifier_name
    ...
    fileprivate func calculateRowY(rowHeights: [CGFloat], rowIndex: Int, spacing: CGFloat) -> CGFloat {
        return Array(0..<rowIndex).reduce(0) {y, index in // swiftlint:disable:this identifier_name
    ...
    override func zoom(_ x: CGFloat, y: CGFloat, centerX: CGFloat, centerY: CGFloat) { // swiftlint:disable:this identifier_name
