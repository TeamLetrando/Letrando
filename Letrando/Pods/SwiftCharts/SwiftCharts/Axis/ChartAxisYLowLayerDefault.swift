...
class ChartAxisYLowLayerDefault: ChartAxisYLayerDefault {
    ...
    override func generateLineDrawer(offset: CGFloat) -> ChartLineDrawer {
        ...
        let p1 = CGPoint(x: origin.x + offset - halfStrokeWidth, y: axis.firstVisibleScreen) // swiftlint:disable:this identifier_name
        let p2 = CGPoint(x: end.x + offset - halfStrokeWidth, y: axis.lastVisibleScreen) // swiftlint:disable:this identifier_name
