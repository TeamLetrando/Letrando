...
open class ChartAxisLayerDefault: ChartAxisLayer {
    ...
    var visibleAxisValuesScreenLocs: [CGFloat] {
        return currentAxisValues.reduce(Array<CGFloat>()) {u, scalar in // swiftlint:disable:this identifier_name
    ...
    open func zoom(_ x: CGFloat, y: CGFloat, centerX: CGFloat, centerY: CGFloat) { // swiftlint:disable:this identifier_name
        fatalError("override")
    }
